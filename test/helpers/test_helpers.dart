...
@GenerateMocks([], customMocks: [
  ...
  MockSpec<CurrentLocationService>(onMissingStub: OnMissingStub.returnDefault),
...
void registerServices() {
  ...
  getAndRegisterCurrentLocationService();
...
MockCurrentLocationService getAndRegisterCurrentLocationService() {
  _removeRegistrationIfExists<CurrentLocationService>();
  final service = MockCurrentLocationService();
  locator.registerSingleton<CurrentLocationService>(service);
  return service;
}

MockWeatherService getAndRegisterRepositoryService() {
